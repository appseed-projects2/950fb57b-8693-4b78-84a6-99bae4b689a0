...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-20 19:10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/950fb57b-8693-4b78-84a6-99bae4b689a0.git
$ cd 950fb57b-8693-4b78-84a6-99bae4b689a0
```
